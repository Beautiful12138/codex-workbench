...
description: 关闭 requirement/归档授权/归档版本/冷历史/archive preflight、version、list。Use when Codex 处理 codex-workbench 需求关闭、版本归档、查询 archive，或用户混淆验收、关闭和归档授权。
---
...
```powershell
codex-workbench requirement close REQ-20260702-001 --note "用户确认需求关闭。" --updated-at "2026-07-02"
codex-workbench archive preflight 1.0.0 --requirement-id REQ-20260702-001 --authorization-note "用户确认可以归档版本。" --archived-at "2026-07-02"
codex-workbench archive version 1.0.0 --requirement-id REQ-20260702-001 --authorization-note "用户确认可以归档版本。" --archived-at "2026-07-02"
codex-workbench archive list
```
