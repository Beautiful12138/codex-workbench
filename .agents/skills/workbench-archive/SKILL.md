...
```powershell
$env:PYTHONPATH='src'
python -m codex_workbench requirement close REQ-001 --note "用户确认需求关闭。" --updated-at "2026-07-02"
python -m codex_workbench archive preflight 1.0.0 --requirement-id REQ-001 --authorization-note "用户确认可以归档版本。" --archived-at "2026-07-02"
python -m codex_workbench archive version 1.0.0 --requirement-id REQ-001 --authorization-note "用户确认可以归档版本。" --archived-at "2026-07-02"
