...
| `in_progress` | 是否 implementation-ready，working_scope、risk_triggers、独立复核、验证和回滚是否清楚 |
...
- high/critical 或真实后果任务有 independent review done、implementation ref 和风险接受；复核主体优先子代理。
