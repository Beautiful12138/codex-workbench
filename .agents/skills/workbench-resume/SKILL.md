...
风险摘要只用于恢复注意力，不替代 task YAML。遇到 high/critical、`environment=unknown`、真实数据、生产/共享环境、权限安全、部署、不可逆、影响他人、验证或回滚不清的任务，不能只靠 `CURRENT.md` 继续推进，必须读取 task 包和 `docs/policies/risk-and-process.md`。
