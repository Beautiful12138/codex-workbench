...
4. 仍不清楚对象时，再读 `CURRENT.md`、`docs/generated/recovery.md`；需要完整活动目录时读 `docs/generated/index.md`。
...
8. 涉及验证、done 或归档时，读 evidence、handoff 和对应 policy。
9. task 显示 high/critical、unknown 或真实后果风险时，读 `docs/policies/risk-and-process.md` 和 task 的 review / implementation 信息。
